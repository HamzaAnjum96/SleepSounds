...
export const BUILTIN_PRESETS: Preset[] = [
  ...
  // Rain on glass (the "At a Window" variant), matching the scene's mood line.
  // The fan already supplies a broadband hush, so the bed is trimmed under the
  // window default — present, but not a second competing curtain.
  { id: 'builtin-fan-rain',      name: 'Fan & Rain',        createdAt: '', masterVolume: 0.8,  state: builtinState([['fan', 0.25], ['rain', 0.50, { surface: 0.40, heaviness: 0.40, intensity: 0.50, drops: 0.55, bed: 0.58, space: 0.62, movement: 0.28, metallic: 0.30 }]]) },
